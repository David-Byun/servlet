...
public class FrontControllerServletV1 extends HttpServlet {
    ...
    public FrontControllerServletV1() {
        controllerMap.put("/front-controller/v1/members/newform", new MemberFormControllerV1());
        controllerMap.put("/front-controller/v1/members/save", new MemberListControllerV1());
        controllerMap.put("/front-controller/v1/members", new MemberSaveControllerV1());
    }
